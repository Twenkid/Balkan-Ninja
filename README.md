...
* Предложени платформи и библиотеки за разработка: OpenCV (Python & C++), PyGame, [<a href="https://github.com/pyglet/pyglet">pyglet</a>, <a href="https://github.com/ubuntunux/PyEngine3D">PyEngine3D</a>?], SDL, Unity, <a href="https://pypi.org/project/PyOpenAL">PyOpenAl</a>, OpenAl, ...? В зависимост от разработчиците, може и няколко варианта.
* Поредица: Пловдив, София, Търново, Варна, Бургас, Планини и др.
* Възможни герои, които са налице с подходящи костюми и външен вид: <b>Нууб Сайбот, Смъртобот, Ли, Контра, Червената шапчица и др.: виж <a href="#geroi">СНИМКИ</a> по-долу</b>
