# Balkan Ninja
(Балканска, за да е по-широкообхватно и да се включат и съседни страни) 
...
* 27.10.2021: Или може би Rust, WGL, Bevy ...? + WebAssembly? (31.1.2022 - Или по-скоро не на Ръст (незрели технологии и малко разработчици?))
...
### Стоичко Христов, Григор, Платин Браминович (Ибра)?, Джоко Нович 
(2.11.2021) Специалитети: Христов - ляв ритник, шут с топка в топките, взима фланелката на Ибра, псува, айнцецвайцетрай дрън... Джоко: удари с тенис ракета и с топка, изстреляна с ракетата; шпагат с приплъзване ... Григор: удари с ракетата, трикови, ...
Пародии: Ибра - псува на сърбохърватски. 
